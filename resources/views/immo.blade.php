...
<html lang="en">
  <head>
    ...
    <title>Polako.fr - Recherche immobilière inversée.</title>
    <link rel="icon" href="{{ asset('storage/css/favicon.jpg') }}">
  ...
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    <div class="vd to/4 tc wf yf">
      <a href="/" class="flex items-center">
        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-black w-14 h-14">
          <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1m1.5.5l-1.5-.5M6.75 7.364V3h-3v18m3-13.636l10.5-3.819" />
        </svg>   
        <h4 class="ml-3 go kk ek">polako.fr</h4>   
      </a>
    ...
    >
      <nav>
        <ul class="tc _o sf yo cg ep">
          <li><a href="/immo" class="xl" :class="{ 'mk': page === 'home' }">Accueil</a></li>
          <li><a href="/immo#features" class="xl">Présentation</a></li>
          <li class="c i" x-data="{ dropdown: false }">
            ...
            <ul class="a" :class="{ 'tc': dropdown }">
              ...
              <li><a href="signin.html" class="xl" :class="{ 'mk': page === 'signin' }">Connexion</a></li>
              <li><a href="signup.html" class="xl" :class="{ 'mk': page === 'signup' }">Inscription</a></li>
      ...
      <div class="tc wf ig pb no">
        ...
        <a href="signin.html" :class="{ 'nk yl' : page === 'home', 'ok' : page === 'home' && stickyMenu }" class="ek pk xl border border-white border-2 rounded-full px-5 py-2"><b>Connexion</b></a>
        <a href="signup.html" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }" class="lk gh dk rg tc wf xf _l border border-white border-2 px-5 py-2"><b>Inscription</b></a>
      </div>
    </div>
  </div>
</header>
    ...
    <main>
      ...
      <section class="gj do ir hj sp jr i pg">
        ...
        ?>
          ...
          <img src="https://polako.fr/storage/images/herob<?php echo $number; ?>.png" alt="shape" class="h q r" />
        ...
        <div class="bb ze ki xn 2xl:ud-px-0">
          <div class="tc _o">
            <div class="animate_left jn/2">
              <h1 class="fk vj zp or kk wm wb">Propriétaires, choisissez votre futur locataire.</h1>
              <p class="fq">
                Finis les innombrables coups de fil et visites inutiles. Parcourez les profils de personnes en recherche d'appartement et proposez votre bien à qui vous le voulez.
              </p>

              <div class="tc tf yo zf mb">
                <a href="#" class="ek jk lk gh gi hi rg ml il vc _d _l"
                  >Je cherche un locataire</a
                >

                <a href="#" class="ek jk lk ghsacha gi hi rg ml il vc _d _l"
      ...
      <section id="features">
        <div class="bb ze ki yn 2xl:ud-px-12.5">
          <div class="tc uf zo xf ap zf bp mq">
            <!-- Small Features Item -->
            <div class="animate_top kn to/3 tc cg oq flex items-center">
              <div class="tc wf xf cf ae cd rg mh">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-white w-12 h-12">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                </svg>

              </div>
              <div>
                <h4 class="ek yj go kk wm xb">Locataires</h4>
                <p>Renseignez vos critères de recherche d'appartement et recevez des propositions.</p>
              </div>
            </div>
            ...
            <div class="animate_top kn to/3 tc cg oq flex items-center">
              ...
              <div>
                <h4 class="ek yj go kk wm xb">Propriétaires</h4>
                <p>Rentrez en contact avec les profils de locataires que vous aurez choisis.</p>
              </div>
            </div>
            ...
            <div class="animate_top kn to/3 tc cg oq flex items-center">
              ...
              <div>
                <h4 class="ek yj go kk wm xb">Evaluation</h4>
                <p>Lisez les avis sur chaque profil propriétaire/locataire avant d'entrer en contact.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bb ze ki xn wq">
          <div class="tc wf gg qq">
            ...
            <div class="animate_left xc gn gg jn/2 i">
              <div>
                <img src="{{ asset('storage/images/shape-05.svg')}}" alt="Shape" class="h -ud-left-5 x" />
                <img src="{{ asset('storage/images/about-01.png')}}" alt="About" class="ib" />
                <img src="{{ asset('storage/images/about-02.png')}}" alt="About" />
              </div>
              <div>
                <img src="{{ asset('storage/images/shape-06.svg')}}" alt="Shape" />
                <img src="{{ asset('storage/images/about-03.png')}}" alt="About" class="ob gb" />
                <img src="{{ asset('storage/images/shape-07.svg')}}" alt="Shape" class="bb" />
              </div>
            </div>

            <!-- About Content -->
            <div class="animate_right jn/2">
              <h4 class="ek yj mk gb">Pourquoi utiliser polako.fr</h4>
              <h2 class="fk vj zp pr kk wm qb">Nous rendons la recherche de locataires plus efficace et plus sûre.</h2>
              <p class="uo">Sur <a href="/">polako.fr</a>, ce ne sont pas les propriétaires qui postent des annonces de location de leurs biens. Les processus est inversé.</p>
              <p class="uo">Les locataires renseignent leurs critères de recherche d'appartement ou maison. Ce sont les propriétaires qui choisissent à qui ils souhaitent proposer leur bien.</p>
              <p class="uo">Ensuite, lorsque le contrat de bail prend fin entre un propriétaire et son locataire, chacun peut laisser une évaluation sur le profil de l'autre.</p>
              <a href="/" data-fslightbox class="vc wf hg mb">
                <span class="tc wf xf be dd rg i gh ua">
                  <span class="nf h vc yc vd rg gh qk -ud-z-1"></span>
                  <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-white w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>

                </span>
                <span class="kk">JE ME LANCE</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <!-- <section class="i pg ji gp uq"> -->
        ...
        <img src="{{ asset('storage/images/shape-08.svg')}}" alt="Shape Bg" class="h q r" />
        <img src="{{ asset('storage/images/shape-09.svg')}}" alt="Shape" class="of h y z/2" />
        <img src="{{ asset('storage/images/shape-10.svg')}}" alt="Shape" class="h _ aa" />
        <img src="{{ asset('storage/images/shape-11.svg')}}" alt="Shape" class="of h m ba" /> -->
          ...
          <div class="wc qf pn xo gg cp"> -->
            ...
            <!-- <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="{{ asset('storage/images/team-01.png')}}" alt="Team" />
            ...
            <!-- <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="{{ asset('storage/images/team-02.png')}}" alt="Team" />
            ...
            <!-- <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="{{ asset('storage/images/team-03.png')}}" alt="Team" />
    ...
    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
        ...
        <!-- <div class="bb ze ki xn yq mb en">
          <div class="wc qf pn xo ng"> -->
            ...
            <!-- <div class="animate_top sg oi pi zq ml il am cn _m">
              <img src="{{ asset('storage/images/icon-04.svg')}}" alt="Icon" />
            ...
            <!-- Service Item -->
            <!-- <div class="animate_top sg oi pi zq ml il am cn _m">
              <img src="{{ asset('storage/images/icon-05.svg')}}" alt="Icon" />
            ...
            <!-- Service Item -->
            <!-- <div class="animate_top sg oi pi zq ml il am cn _m">
              <img src="{{ asset('storage/images/icon-06.svg')}}" alt="Icon" />
            ...
            <!-- Service Item -->
            <!-- <div class="animate_top sg oi pi zq ml il am cn _m">
              <img src="{{ asset('storage/images/icon-07.svg')}}" alt="Icon" />
      ...
      <!-- <section x-data="setup()" class="i pg fh rm ji gp uq"> -->
        <!-- Bg Shapes -->
<!--         <img src="{{ asset('storage/images/shape-06.svg')}}" alt="Shape" class="h aa y" />
        <img src="{{ asset('storage/images/shape-03.svg')}}" alt="Shape" class="h ca u" />
        <img src="{{ asset('storage/images/shape-07.svg')}}" alt="Shape" class="h w da ee" />
        <img src="{{ asset('storage/images/shape-12.svg')}}" alt="Shape" class="h p s" />
        <img src="{{ asset('storage/images/shape-13.svg')}}" alt="Shape" class="h r q" /> -->
          ...
          <!-- <div class="projects-wrapper tc -ud-mx-5">
            ...
            <!-- <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
              <div class="c i pg sg z-1">
                <img src="{{ asset('storage/images/project-01.png')}}" alt="Project" />
            ...
            <!-- <div class="project-item wi fb vd jn/2 to/3 digital">
              <div class="c i pg sg z-1">
                <img src="{{ asset('storage/images/project-02.png')}}" alt="Project" />
           ...
           <!--  <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
              <div class="c i pg sg z-1">
                <img src="{{ asset('storage/images/project-04.png')}}" alt="Project" />
            ...
            <!-- <div class="project-item wi fb vd vo/3 digital ecommerce">
              <div class="c i pg sg z-1">
                <img src="{{ asset('storage/images/project-03.png')}}" alt="Project" />
    ...
    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
                ...
                <!-- <div class="swiper-slide">
                  <div class="i hh rm sg vk xm bi qj"> -->
                    ...
                    <div class="tc sf rn tn un zf dp">
                      <img class="bf" src="{{ asset('storage/images/testimonial.png')}}" alt="User" />

                      <div>
                        <img src="{{ asset('storage/images/icon-quote.svg')}}" alt="Quote" />
                        ...
                        <div class="tc yf vf">
                          ...
                          <img class="rk" src="{{ asset('storage/images/brand-light-02.svg')}}" alt="Brand" />
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <section class="i pg qh rm ji hp">
        <img src="{{ asset('storage/images/shape-11.svg')}}" alt="Shape" class="of h ga ha ke" />
        <img src="{{ asset('storage/images/shape-07.svg')}}" alt="Shape" class="h ia o ae jf" />
        <img src="{{ asset('storage/images/shape-14.svg')}}" alt="Shape" class="h ja ka" />
        <img src="{{ asset('storage/images/shape-15.svg')}}" alt="Shape" class="h q p" />

        <div class="bb ze i va ki xn br">
          <div class="tc uf sn tn xf un gg">
            <div class="animate_top me/5 ln rj">
              <h2 class="gk vj zp or kk wm hc">785</h2>
              <p class="ek bk aq">Propriétaires</p>
            </div>
            <div class="animate_top me/5 ln rj">
              <h2 class="gk vj zp or kk wm hc">533</h2>
              <p class="ek bk aq">Locataires</p>
            </div>
            <div class="animate_top me/5 ln rj">
              <h2 class="gk vj zp or kk wm hc">865</h2>
              <p class="ek bk aq">Annonces</p>
            </div>
            <div class="animate_top me/5 ln rj">
              <h2 class="gk vj zp or kk wm hc">346</h2>
              <p class="ek bk aq">Biens disponibles</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
        ...
        <!-- <div class="bb ze ah ch pm hj xp ki xn 2xl:ud-px-49 bc">
          <div class="wc rf qn zf cp kq xf wf">
            <a href="#" class="rc animate_top">
              <img class="th wl ml il zl om" src="{{ asset('storage/images/brand-light-01.svg')}}" alt="Clients" />
              <img class="xc sk ml il zl nm" src="{{ asset('storage/images/brand-dark-01.svg')}}" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="{{ asset('storage/images/brand-light-02.svg')}}" alt="Clients" />
              <img class="xc sk ml il zl nm" src="{{ asset('storage/images/brand-dark-02.svg')}}" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="{{ asset('storage/images/brand-light-03.svg')}}" alt="Clients" />
              <img class="xc sk ml il zl nm" src="{{ asset('storage/images/brand-dark-03.svg')}}" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="{{ asset('storage/images/brand-light-04.svg')}}" alt="Clients" />
              <img class="xc sk ml il zl nm" src="{{ asset('storage/images/brand-dark-04.svg')}}" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="{{ asset('storage/images/brand-light-05.svg')}}" alt="Clients" />
              <img class="xc sk ml il zl nm" src="{{ asset('storage/images/brand-dark-05.svg')}}" alt="Clients" />
            </a>
            <a href="#" class="rc animate_top">
              <img class="tk ml il zl om" src="{{ asset('storage/images/brand-light-06.svg')}}" alt="Clients" />
              <img class="xc sk ml il zl nm" src="{{ asset('storage/images/brand-dark-06.svg')}}" alt="Clients" />
            </a>
          </div>
        </div>
      </section> -->
      ...
      <section class="ji gp uq">
        <!-- Section Title Start -->
        <div
          x-data="{ sectionTitle: `Actualités`, sectionTitleText: `Suivez nos derniers articles et restez informés des dernières tendances du marché immobilier et de l'investissement.`}"
        >
          <div class="animate_top bb ze rj ki xn vq">
    <h2
            x-text="sectionTitle"
          ...
          <div class="wc qf pn xo zf iq">
            ...
            <div class="animate_top sg vk rm xm">
              <div class="c rc i z-1 pg">
                <img class="w-full" src="{{ asset('storage/images/blog-01.png')}}" alt="Blog" />
              ...
              <div class="yh">
                <div class="tc uf wf ag jq">
                  <div class="tc wf ag">
                    <img src="{{ asset('storage/images/icon-man.svg')}}" alt="User" />
                    <p>Sacha Rado</p>
                  </div>
                  <div class="tc wf ag">
                    <img src="{{ asset('storage/images/icon-calender.svg')}}" alt="Calender" />
                    <p>25 Dec, 2022</p>
                  </div>
                </div>
                <h4 class="ek tj ml il kk wm xl eq lb">
                  <a href="">L'évolution des taux d'intérêt en 2023.</a>
                </h4>
              </div>
            </div>
            ...
            <div class="animate_top sg vk rm xm">
              <div class="c rc i z-1 pg">
                <img class="w-full" src="{{ asset('storage/images/blog-02.png')}}" alt="Blog" />
              ...
              <div class="yh">
                ...
                <h4 class="ek tj ml il kk wm xl eq lb">
                  <a href="">Comment gérer ses biens en LMNP.</a>
                </h4>
              </div>
            </div>
            ...
            <div class="animate_top sg vk rm xm">
              <div class="c rc i z-1 pg">
                <img class="w-full" src="{{ asset('storage/images/blog-03.png')}}" alt="Blog" />
              ...
              <div class="yh">
                ...
                <h4 class="ek tj ml il kk wm xl eq lb">
                  <a href="">Transformer ses impôts en capital immobilier.</a>
                </h4>
              </div>
            </div>
          </div>
        ...
        <!-- <div class="i va bb ye ki xn wq jb mo">
          <div class="tc uf sn tf rn un zf xl:gap-10">
            <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg"> -->
              <!-- Bg Shapes -->
              <!-- <img src="{{ asset('storage/images/shape-03.svg')}}" alt="Shape" class="h la x wd" />
              <img src="{{ asset('storage/images/shape-06.svg')}}" alt="Shape" class="h la ma ne kf" />
  ...
  <!-- Bg Shape -->
  <!-- <img class="h p q" src="{{ asset('storage/images/shape-16.svg')}}" alt="Bg Shape" />
   ...
   <!--  <div class="ji gp">
      <div class="tc uf ap gg fp">
        <div class="animate_top zd/2 to/4">
          <a href="index.html">
            <img src="{{ asset('storage/images/logo-light.svg')}}" alt="Logo" class="om" />
            <img src="{{ asset('storage/images/logo-dark.svg')}}" alt="Logo" class="xc nm" />
          </a>
    ...
    <div class="bh ch pm tc uf sf yo wf xf ap cg fp bj">
      <div class="animate_top">
        <ul class="tc wf gg">
          <li><a href="#" class="xl">Mentions légales.</a></li>
      ...
      <div class="animate_top">
        <p>&copy; 2023 Polako.fr | All rights reserved</p>
      </div>
    </div>
    <!-- Footer Bottom -->
  </div>
...
>
  ...
  <script defer src="{{ asset('storage/js/bundle.js')}}"></script></body>
</html>
